...
function sendToPipedream(prompt, memberId, callback, url) {
...
const prompt1 = `Generate a detailed market analysis for a product or service that includes but is not limited to the following values (please include analysis beyond what is listed here if possible):
...
Anicilalry products or services that are being sold: ${ancillaryProduct},
...
const prompt2 = `Generate a detailed competitor analysis for a product or service that includes but is not limited to the following values (please include analysis beyond what is listed here if possible):
...
const prompt3 = `Generate a detailed numbered list of 6 potential consumer personas/audience segments to target when marketing for a product or service that includes but is not limited to the following values (please include analysis beyond what is listed here if possible):
...
const prompt4 = `Generate a detailed marketing plan/strategy broken out into quarterly segments for a product or service that includes but is not limited to the following conditions (please include analysis beyond what is listed here if possible):
...
const prompt5 = `Generate a detailed conversion rate optimization checklist for a website that sells a product or service that includes but is not limited to the following conditions (please include analysis beyond what is listed here if possible):
...
const prompt6 = `Generate a detailed SEO & keyword analysis for a website that sells a product or service that includes but is not limited to the following conditions (please include analysis beyond what is listed here if possible):
...
initScript("", prompt1, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("2", prompt2, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("3", prompt3, "https://eozc33fki2b37c1.m.pipedream.net");
initScript("4", prompt4, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("5", prompt5, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("6", prompt6, "https://eow0cpoqxmz9upi.m.pipedream.net");
