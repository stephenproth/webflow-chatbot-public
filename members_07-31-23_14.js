...
function initScript(suffix, customPrompt, url, memberId, title) {
  ...
  function generateCustomResponse(suffix, customPrompt, url, title) {
...
const title1 = `Market Analysis`;
const title2 = `Competitor Analysis`;
const title3 = `Audience Segments`;
const title4 = `Marketing Plan`;
const title5 = `CRO Checklist`;
const title6 = `SEO Analysis`;

initScript("", prompt1, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId, title1);
initScript("2", prompt2, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId, title2);
initScript("3", prompt3, "https://eozc33fki2b37c1.m.pipedream.net", memberId), title3;
initScript("4", prompt4, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId, title4);
initScript("5", prompt5, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId), title5;
initScript("6", prompt6, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId), title6;
