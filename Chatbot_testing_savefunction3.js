...
function addMessageToWidget(e, t, o = null, n = null) {
    ...
    if (t === "assistant") {  // If this is a bot message
        let botMessageHTML = converter.makeHtml(e);  // Convert markdown to HTML

        if (o) {
            // If there's a link, create an anchor tag and append it to the message
            let s = document.createElement("a");
            s.href = o;
            s.target = "_blank";
            s.textContent = "link";
            r.innerHTML = botMessageHTML + " ";
            r.appendChild(s);
        } else {
            r.innerHTML = botMessageHTML;  
        }
