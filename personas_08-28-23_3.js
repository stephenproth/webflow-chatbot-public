...
function sendToPipedream(prompt, memberId, personaId, personaName, callback, url, title, suffix) {
    ...
    console.log('Authoritative checkbox:', document.getElementById('Authoritative' + suffix));
    console.log('Whimsical checkbox:', document.getElementById('Whimsical' + suffix));
    console.log('Educational checkbox:', document.getElementById('Educational' + suffix));
    console.log('Inspirational checkbox:', document.getElementById('Inspirational' + suffix));
    console.log('Witty checkbox:', document.getElementById('Witty' + suffix));
    console.log('Minimalistic checkbox:', document.getElementById('Minimalistic' + suffix));
    console.log('Nostalgic checkbox:', document.getElementById('Nostalgic' + suffix));
    console.log('Relatable checkbox:', document.getElementById('Relatable' + suffix));
  ...
  const styles = {
    photorealistic: document.getElementById('photorealistic' + suffix).checked,
    illustrated: document.getElementById('illustrated' + suffix).checked,
    cinematic: document.getElementById('cinematic' + suffix).checked,
    modern: document.getElementById('modern' + suffix).checked,
    retro: document.getElementById('retro' + suffix).checked,
    abstract: document.getElementById('abstract' + suffix).checked,
    moody: document.getElementById('moody' + suffix).checked,
    vibrant: document.getElementById('vibrant' + suffix).checked,
  };

      // Get the tone of voice from the form
    const toneOfVoice = {
        Authoritative: document.getElementById('Authoritative' + suffix).checked,
        Whimsical: document.getElementById('Whimsical' + suffix).checked,
        Educational: document.getElementById('Educational' + suffix).checked,
        Inspirational: document.getElementById('Inspirational' + suffix).checked,
        Witty: document.getElementById('Witty' + suffix).checked,
        Minimalistic: document.getElementById('Minimalistic' + suffix).checked,
        Nostalgic: document.getElementById('Nostalgic' + suffix).checked,
        Relatable: document.getElementById('Relatable' + suffix).checked,
    };
