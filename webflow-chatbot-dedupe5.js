...
}, ] ), $( "#user-input" ).keypress( function ( e )
{
  if ( 13 == e.which )
  {
    ...
    if ( t )
    {
      addMessageToWidget( t, "user" ), conversationHistory.push(
      {
        role: "user",
        content: t
      } ), saveConversationHistory();
      let o = getPresetResponse( t );
      o ? ( addMessageToWidget( o, "assistant" ), conversationHistory.push(
      {
        role: "assistant",
        content: o
      } ), saveConversationHistory() ) : sendToPipedream( t, function ( e )
      {
        addMessageToWidget( e, "assistant" )
      } ), $( "#user-input" ).val( "" )
    }
  }
} ), addSpinnerStyles(), conversationHistory.filter( e => "system" !== e.role ).forEach( e => addMessageToWidget( e.content, e.role ) ), document.addEventListener( "DOMContentLoaded", function ()
{
