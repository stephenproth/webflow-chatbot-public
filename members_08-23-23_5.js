...
function initScript(suffix, customPrompt, url, memberId, title) {
    ...
    window.addEventListener("load", function () {
        ...
        submitButton.addEventListener("click", function (e) {
            e.preventDefault();
            let styles = {
                photorealistic: document.getElementById('photorealistic').checked,
                illustrated: document.getElementById('illustrated').checked,
                cinematic: document.getElementById('cinematic').checked,
                modern: document.getElementById('modern').checked,
                retro: document.getElementById('retro').checked,
                abstract: document.getElementById('abstract').checked,
                moody: document.getElementById('moody').checked,
                vibrant: document.getElementById('vibrant').checked,
            }
            generateCustomResponse(suffix, customPrompt, url, styles, title);
        });
        if (currentResponse) {
...
function generateCustomResponse(suffix, customPrompt, url, styles, title) {
...
function sendToPipedream(prompt, memberId, callback, url, title, styles) {
