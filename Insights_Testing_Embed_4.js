...
function sendToPipedreamInsights( e, t )
{
...
function addMessageToWidget(e, t, o = null, n = null) {
    ...
    if (t === "assistant") {
        ...
        // Your SVG icon code
        let svgIcon = `<svg style="background-color: transparent;" height="15px" viewBox="-40 0 512 512" width="15px" xmlns="http://www.w3.org/2000/svg" id="fi_1621635" style="padding: 0.5px;"><path d="m271 512h-191c-44.113281 0-80-35.886719-80-80v-271c0-44.113281 35.886719-80 80-80h191c44.113281 0 80 35.886719 80 80v271c0 44.113281-35.886719 80-80 80zm-191-391c-22.054688 0-40 17.945312-40 40v271c0 22.054688 17.945312 40 40 40h191c22.054688 0 40-17.945312 40-40v-271c0-22.054688-17.945312-40-40-40zm351 261v-302c0-44.113281-35.886719-80-80-80h-222c-11.046875 0-20 8.953125-20 20s8.953125 20 20 20h222c22.054688 0 40 17.945312 40 40v302c0 11.046875 8.953125 20 20 20s20-8.953125 20-20zm0 0"></path></svg>`;
...
$( "#user-input" ).keypress( function ( e ) {
    if ( 13 == e.which ) {
      ...
      if ( t ) {
        ...
        if (o) {
          ...
          sendToPipedreamInsights( t, function ( e ) {
  ...
  document.addEventListener('DOMContentLoaded', (event) => {
    ...
    systemMessage = `You are a chatbot designed to help businesses generate market analysis, 
    marketing plans/strategies, competitor analysis, audience segmentation/consumer personas, and more. 
    The specific business you are messaging with now has a product or service that includes the following details (please be advised to disregard any empty fields):
    Product Category: ${productType},
    Product Description: ${productDescription}, 
    Product Market: ${marketLocation},
    Business Owners Name: ${firstName} ${lastName},
    Monthly Recurring Revenue: ${monthlyRevenue},
    Monthly Website Traffic: ${monthlyVisitors},
    List of potential competitors: ${competitorList},
    ...
    Key target audience information: ${audienceDetails},`;
