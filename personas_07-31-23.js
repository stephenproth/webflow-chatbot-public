let productType, serviceType, productDescription, memberId, personaName, businessName, personaDesc;
...
const prompt2 = `Generate a detailed numbered list of 6 potential interests and/or activities that could be applied
a consumer persona/audience segment titled: ${personaName}; that is described as: ${personaDesc}; for a business that offers 
a product/service that falls under the category of: ${productType}; and is described as: ${productDescription}.`;

const prompt3 = `Generate a detailed numbered list of 6 specific entertainment-based interests and/or activities including items that would fall under the categories 
