...
function initScript(suffix, customPrompt, url, productId, title) {
    ...
    window.addEventListener("load", function () {
      // Check for stored text and populate thee response container if it exists
...
initScript("P7", prompt7, "https://eod7ggz3z4rhivo.m.pipedream.net", productId, "SEO Keywords & Strategy");
