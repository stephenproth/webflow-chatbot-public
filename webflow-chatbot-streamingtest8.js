function saveConversationHistory() {
  ...
  function clearChatHistory() {
    ...
    addMessageToWidget("Hi, how can I help you today?", "assistant", null, false);
  ...
  addMessageToWidget(initialOptions, "bot-options", null, false);
  conversationHistory.push({ role: "bot-options", content: initialOptions });
  ...
  .forEach((message, index) => {
    if (userMessagePending && message.role === "assistant") {
      userMessagePending = false;
      addMessageToWidget(conversationHistory[index - 1].content, "user", null, false);
      handleUserOption(conversationHistory[index - 1].content);
    }
