...
function generateCustomResponse(suffix, customPrompt, url, styles, toneOfVoice, title) {
    ...
    prompt = prompt.replace('productType_placeholder', productType);
    prompt = prompt.replace('productDescription_placeholder', productDescription);
    prompt = prompt.replace('marketLocation_placeholder', marketLocation);
    prompt = prompt.replace('firstName_placeholder', firstName);
    prompt = prompt.replace('lastName_placeholder', lastName);
    ...
    prompt = prompt.replace('businessName_placeholder', businessName);
    prompt = prompt.replace('primaryProduct_placeholder', primaryProduct);
    prompt = prompt.replace('ancillaryProduct_placeholder', ancillaryProduct);
    prompt = prompt.replace('audienceAge_placeholder', audienceAge);
    prompt = prompt.replace('audienceGender_placeholder', audienceGender);
    prompt = prompt.replace('conversionRate_placeholder', conversionRate);
    prompt = prompt.replace('averageOrderValue_placeholder', averageOrderValue);
    prompt = prompt.replace('monthlyBudget_placeholder', monthlyBudget);
    prompt = prompt.replace('digitalBudget_placeholder', digitalBudget);
    prompt = prompt.replace('influencerBudget_placeholder', influencerBudget);
    prompt = prompt.replace('onlineSales_placeholder', onlineSales);
    prompt = prompt.replace('retailSales_placeholder', retailSales);
...
Product Category: productType_placeholder,
Product Description: productDescription_placeholder, 
Product Market: marketLocation_placeholder,
Business Owners Name: firstName_placeholder lastName_placeholder,
...
Business Name: businessName_placeholder, 
Primary Product or service that is being sold: primaryProduct_placeholder,
Ancillary products or services that are being sold: ancillaryProduct_placeholder,
Average ages of target audience: audienceAge_placeholder,
Typical gender of target audience: audienceGender_placeholder,
Average website conversion rate: conversionRate_placeholder,
Average website purchase order value: averageOrderValue_placeholder,
Estimated overall monthly marketing budget: monthlyBudget_placeholder,
Estimated monthly digital advertising budget: digitalBudget_placeholder,
Estimated monthly influencer or brand collaboration budget: influencerBudget_placeholder,
Average percentage of total sales that are made direct-to-consumer online: onlineSales_placeholder,
Average percentage of total sales that are from in-person retail: retailSales_placeholder,
