...
function showLoadingAnimation(suffix) {
  ...
  function displayAIOutput(response, suffix) {
    ...
    md.use(window.markdownitLinkify);
    const responseContainer = document.getElementById("response-container" + suffix);
    ...
    localStorage.setItem('aiText' + suffix, formattedResponse);
...
initScript("7", prompt1, "https://eow9kj7yrsd5v27.m.pipedream.net");
initScript("8", prompt2, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("9", prompt3, "https://eo6ll1l9xtq9x8n.m.pipedream.net");
initScript("10", prompt4, "https://eodyl3ogsspcoca.m.pipedream.net");
initScript("11", prompt5, "https://eoeh0oukg24dmzn.m.pipedream.net");
initScript("12", prompt6, "https://eo44dpdqeblzb7g.m.pipedream.net");
initScript("13", prompt7, "https://eou9am0xy8c9cdb.m.pipedream.net");
initScript("14", prompt8, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("15", prompt9, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("16", prompt10, "https://eow0cpoqxmz9upi.m.pipedream.net");
initScript("17", prompt11, "https://eow0cpoqxmz9upi.m.pipedream.net");
