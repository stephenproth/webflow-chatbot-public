...
function initScript(suffix, customPrompt, url, memberId) {
  let currentResponse = "";
...
initScript("", prompt1, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId);
initScript("2", prompt2, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId);
initScript("3", prompt3, "https://eozc33fki2b37c1.m.pipedream.net", memberId);
initScript("4", prompt4, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId);
initScript("5", prompt5, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId);
initScript("6", prompt6, "https://eow0cpoqxmz9upi.m.pipedream.net", memberId);
